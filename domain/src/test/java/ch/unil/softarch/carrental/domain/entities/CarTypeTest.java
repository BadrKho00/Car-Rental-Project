package ch.unil.softarch.carrental.domain.entities;

import ch.unil.softarch.carrental.domain.enums.DriveType;
import ch.unil.softarch.carrental.domain.enums.Transmission;
